...
const Products = () => {
  ...
  const btnBaseClass =
    "mt-4 w-full px-4 py-2 rounded-lg transition-transform duration-200";
  const activeClass =
          ...
          >
            ...
            <div className="p-4 text-center">
              ...
              <p className="mt-2 text-sm text-gray-600 truncate">
                <PortableText value={[{ _type: 'block', children: [{ _type: 'span', text: product.description }] }]} /> {/* Render rich text */}
              </p>
